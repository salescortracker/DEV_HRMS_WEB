...
@Component({
  selector: 'app-manager-approval-wfh',
  standalone: false,
  templateUrl: './manager-approval-wfh.component.html',
  styleUrl: './manager-approval-wfh.component.css'
})
export class ManagerApprovalWfhComponent {
