...
@Component({
  selector: 'app-employee-submission',
  standalone: false,
  templateUrl: './employee-submission.component.html',
  styleUrl: './employee-submission.component.css'
})
export class EmployeeSubmissionComponent {
